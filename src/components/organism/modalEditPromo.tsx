...
//   { id: 2, name: "Nonaktif", value: "non-Aktif" },
// ];
// const typeOptions = [
...
//   menus,
// }: EditMenuModalProps) {
//   const [editedPromo, setEditedPromo] = useState<promoType | null>(promo);
//   const [selectedImage, setSelectedImage] = useState<File | null>(null);
//   const [previewImage, setPreviewImage] = useState<string>("");
//   const [promoSyarat, setPromoSyarat] = useState<{
//     id: number;
//     name: string;
//     value: string;
//   } | null>(null);
...
//     if (promo?.promo_menus && promo.promo_menus.length > 0) {
//       setPromoSyarat(
//         promoSyaratOptions.find((opt) => opt.value === "menu") || null
//       );
//     } else if (promo?.minimum_purchase) {
//       setPromoSyarat(
//         promoSyaratOptions.find((opt) => opt.value === "purchase") || null
//       );
//     }
//   }, [promo]);

//   const handleChange = (field: keyof promoType, value: any) => {
//     if (editedPromo) {
//       setEditedPromo({ ...editedPromo, [field]: value });
//     }
//   };
...
//   //     );
//   //     handleChange("promo_type", selectedType?.value || "");
//   //   };
...
//   };
//   const handleSyaratChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
//     const selectedValue = e.target.value;
//     const selectedSyarat = promoSyaratOptions.find(
//       (option) => Number(option.id) === Number(selectedValue)
//     );

//     setPromoSyarat(selectedSyarat || null);

//     // ← PENTING: Reset data berlawanan saat ganti syarat
//     if (selectedSyarat?.value === "purchase") {
//       // Ganti ke purchase: hapus promo_menus, set minimum_purchase
//       handleChange("promo_menus", []); // ← reset jadi array kosong
//     } else if (selectedSyarat?.value === "menu") {
//       // Ganti ke menu: hapus minimum_purchase, set promo_menus
//       handleChange("minimum_purchase", 0); // ← reset ke 0
//     }
//   };
...
//       formData.append("name", editedPromo.name);
//       formData.append("promo_type", editedPromo.promo_type);
//       formData.append("status", editedPromo.status);
//       formData.append("start_date", editedPromo.start_date.toString());
//       formData.append("end_date", editedPromo.end_date.toString());
//       formData.append("description", editedPromo.description);
//       formData.append("promo_code", editedPromo.promo_code);

//       if (selectedImage) {
//         formData.append("image", selectedImage);
//       }
//       if (
//         editedPromo.promo_menus !== undefined &&
//         editedPromo.promo_menus.length > 0
//       ) {
//         const menuIds = editedPromo.promo_menus.map((pm) => pm.menu.id);
//         formData.append("menu_id", JSON.stringify(menuIds));
//       } else {
//         formData.append(
//           "minimum_purchase",
//           editedPromo.minimum_purchase?.toString() || ""
//         );
//       }
//       if (editedPromo.promo_type === "amount" && editedPromo.amount_value) {
//         formData.append("amount_value", editedPromo.amount_value.toString());
//       } else {
//         formData.append(
//           "percent_value",
//           editedPromo.percent_value?.toString() || ""
//         );
//       }
//       await updatePromo(editedPromo.id, formData);
...
//               alt={editedPromo.name || "Menu Image"}
...
//             <SelectLabel
//               children="Tipe Promo"
//               selectFormProps={{ id: "promo_type", options: typeOptions }}
//               selectProps={{
//                 value: editedPromo.promo_type,
...
//             <SelectLabel
//               children="Status"
//               selectFormProps={{ id: "status", options: statusOptions }}
//               selectProps={{
...
//                 label="Tanggal Mulai"
//                 value={
//                   dayjs(editedPromo.start_date).isValid()
//                     ? dayjs(editedPromo.start_date)
//                     : null
//                 }
//                 onChange={(date) =>
//                   handleChange(
...
//                 value={
//                   dayjs(editedPromo.end_date).isValid()
//                     ? dayjs(editedPromo.end_date)
//                     : null
//                 }
//                 onChange={(date) =>
//                   handleChange(
...
//                 className="xs:flex-1"
//               inputProps={{
//                 value: editedPromo.promo_code,
//                 onChange: (e) => handleChange("promo_code", e.target.value),
//               }}
//             />
//             {editedPromo.promo_type === "amount" ? (
...
//                   inputVariant="number"
//                   inputProps={{
//                     value: editedPromo.amount_value,
//                     onChange: (e) =>
//                       handleChange("amount_value", Number(e.target.value)),
//                   }}
//                 />
//               </div>
//             ) : (
...
//                   inputVariant="number"
//                   inputProps={{
//                     value: editedPromo.percent_value,
//                     onChange: (e) =>
//                       handleChange("percent_value", Number(e.target.value)),
//                   }}
//                 />
//               </div>
//             )}
...
//                 inputVariant="number"
//                 inputProps={{
//                   value: editedPromo.minimum_purchase,
//                   onChange: (e) =>
//                     handleChange("minimum_purchase", Number(e.target.value)),
//                 }}
//               />
//             ) : (
...
//                     menus.map((menu) => {
//                       const isChecked =
//                         editedPromo.promo_menus?.some(
//                           (pm) => pm.menu.id === menu.id
//                         ) ?? false;
...
//                               handleChange("promo_menus", newMenus);
//                             }}
...
//                       ✓ {editedPromo.promo_menus.length} menu terpilih
//                     </Text>
//                   )}
//               </div>
//             )}
...
//               {editedPromo.description.length || 0}/300 karakter
//             </Text>
//           </div>
