...
export const ModalPesananOwner = ({ order }: modalPesananBaruProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col justify-between flex-1 gap-3`}>
        <div
          className={`flex  flex-col justify-between pt-2 min-h-[10rem] border-b-1 border-primary pb-3 `}
        >
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center">
        ...
        <div className="flex flex-col gap-1 border-b-1 border-primary pb-3">
        ...
        <div className={`flex flex-col gap-5  ${order?.status === "Ditolak" ? "border-b-1 border-primary pb-3" : ""}`}>
          <div className="flex flex-col gap-2">
            <div className="flex justify-between">
              <Text size="caption" textColor="secondary">
                Metode Pembayaran
            ...
            <div className="flex justify-between">
              ...
              <Text size="caption" className="text-secondary">
                {order?.point_history
                  ...
                  .reduce((total, point) => total + point.amount, 0) || 0}{" "}
                Poin
              </Text>
            </div>
            <div className="flex justify-between">
