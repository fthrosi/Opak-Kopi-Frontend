...
export default function Header() {
  return (
    <Pages className="gap-5 lg:gap-9 xl:gap-13 z-2 h-full">
      ...
      <ButtonText
        ...
        buttonAsChild={false}
        buttonText="default"
        buttonClassName="hover:bg-primary xl:shadow xl:shadow-primary/70 mx-4 md:mx-[clamp(1.25rem,4vw,6.75rem)] lg:mx-20 xl:mx-35 2xl:mx-40 h-auto w-fit rounded-[0.2rem] text-[0.75rem] sm:text-[clamp(0.75rem,1.3vw,0.813rem)] lg:text-[clamp(0.813rem,1vw,0.875rem)] py-1 px-2 2xl:py-2 2xl:px-[1.13rem]"
      />
    </Pages>
  );
}
